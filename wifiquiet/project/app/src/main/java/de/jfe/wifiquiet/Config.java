...
final class Config {
    ...
    static final String ENGINE_ENABLED="engine_enabled", SERVICE_RUNNING="service_running",
            ENGINE_ACTIVE_IDS="engine_active_ids", MANUAL_ACTIVE_IDS="manual_active_ids", SNOOZED_IDS="snoozed_ids",
            ...
            ORIGINAL_BRIGHTNESS="original_brightness", ORIGINAL_BRIGHTNESS_MODE="original_brightness_mode", ORIGINAL_ROTATION="original_rotation", ORIGINAL_TIMEOUT="original_timeout";
    private Config(){}
